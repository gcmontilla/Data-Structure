...
STokenizer& operator>>(STokenizer &s, Token &t) {
    ...
    } else if (s.get_token(START_SPECIALS, token)){
        t = Token(token, SPECIAL);
    } else {
...
void STokenizer::make_table(int _table[][MAX_COLUMNS]) {
    ...
    // Create state for special;
    mark_cell(15, _table, '\"', 16);
    mark_cells(16, _table, LETTERS, 17);
    mark_cells(17, _table, LETTERS, 17);
    mark_cell(17, _table, '_', 18);
    mark_cell(17, _table, ' ', 18);
    mark_cell(17, _table, '.', 18);
    mark_cells(18, _table, LETTERS, 19);
    mark_cell(19, _table, '.', 19);
    mark_cells(19, _table, LETTERS, 19);
    mark_cell(19, _table, '\"', 20);
...
//        cout << state << " " << int(_buffer[_pos]) << " " << _buffer[_pos] << endl;
